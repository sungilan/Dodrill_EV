Shader "Custom/Shader_Hair_2nd_Pass"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g1164( half3 NormalTS, half3x3 TBN )
			{
			...
			half3 Expression_HairLighting_Additional126_g1160( half3 Color, half3 TangentWorld, half3 ViewDir, half3 NormalWorld, half3 SpecularColor, half SpecularTint, half SpecularPower, half SpecularMultiplier, half3 PositionWorld, half Translucency, half RimTransmission, half RimPower )
			{
				float3 addColor = 0;
				half4 shadowMask = 1;
						 ...
						 ) : SV_Target
			{
				...
				half3 NormalTS13_g1164 = ( ( appendResult98_g1160 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_tangentWS = input.ase_texcoord6.xyz;
				half3 ase_normalWS = input.ase_texcoord7.xyz;
				half3 Binormal5_g1164 = ( ( input.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_normalWS , ase_tangentWS ) );
				half3x3 TBN1_g1164 = float3x3( ase_tangentWS, Binormal5_g1164, ase_normalWS );
				half3x3 TBN13_g1164 = TBN1_g1164;
				half3 localTangentToWorld13_g1164 = TangentToWorld13_g1164( NormalTS13_g1164 , TBN13_g1164 );
				half3 flowTangent107_g1160 = localTangentToWorld13_g1164;
				...
				half3 normalizeResult10_g1161 = normalize( ( flowTangent107_g1160 + ( worldNormal86_g1160 * lerpResult81_g1160 ) ) );
				half3 shiftedTangent119_g1160 = normalizeResult10_g1161;
				half3 viewDIr52_g1162 = WorldViewDirection;
				half3 worldLight248_g1160 = SafeNormalize( _MainLightPosition.xyz );
				half3 lightDir55_g1162 = worldLight248_g1160;
				half3 normalizeResult14_g1163 = normalize( ( viewDIr52_g1162 + lightDir55_g1162 ) );
				half dotResult16_g1163 = dot( shiftedTangent119_g1160 , normalizeResult14_g1163 );
				half smoothstepResult22_g1163 = smoothstep( -1.0 , 0.0 , dotResult16_g1163);
				...
				half4 temp_output_13_0_g1162 = ( ( smoothstepResult22_g1163 * pow( saturate( ( 1.0 - ( dotResult16_g1163 * dotResult16_g1163 ) ) ) , specularPower237_g1160 ) ) * temp_output_132_0_g1160 * temp_output_131_0_g1160 );
				...
				half4 lerpResult18_g1157 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				...
				half temp_output_27_0_g1157 = root58;
				half lerpResult23_g1157 = lerp( temp_output_27_0_g1157 , ( 1.0 - temp_output_27_0_g1157 ) , _InvertRootMap);
				half4 lerpResult3_g1157 = lerp( _RootColor , _EndColor , lerpResult23_g1157);
				half lerpResult40_g1157 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1157);
				half4 lerpResult6_g1157 = lerp( lerpResult18_g1157 , lerpResult3_g1157 , ( lerpResult40_g1157 * _GlobalStrength ));
				half3 From8_g1158 = _HighlightADistribution;
				half ID8_g1158 = idMap383;
				half Fac8_g1158 = _HighlightAStrength;
				half localThreePointDistribution8_g1158 = ThreePointDistribution( From8_g1158 , ID8_g1158 , Fac8_g1158 );
				half temp_output_24_0_g1158 = root58;
				half lerpResult16_g1158 = lerp( temp_output_24_0_g1158 , ( 1.0 - temp_output_24_0_g1158 ) , _HighlightAOverlapInvert);
				half4 lerpResult18_g1158 = lerp( lerpResult6_g1157 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1158 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1158 ) ) * _HighlightBlend ) ));
				half3 From8_g1159 = _HighlightBDistribution;
				half ID8_g1159 = idMap383;
				half Fac8_g1159 = _HighlightBStrength;
				half localThreePointDistribution8_g1159 = ThreePointDistribution( From8_g1159 , ID8_g1159 , Fac8_g1159 );
				half temp_output_24_0_g1159 = root58;
				half lerpResult16_g1159 = lerp( temp_output_24_0_g1159 , ( 1.0 - temp_output_24_0_g1159 ) , _HighlightBOverlapInvert);
				half4 lerpResult18_g1159 = lerp( lerpResult18_g1158 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1159 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1159 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				half4 staticSwitch95 = lerpResult18_g1159;
				#else
				...
				half4 temp_output_32_0_g1162 = temp_output_42_0_g1160;
				half temp_output_172_0_g1160 = _SpecularMix;
				half4 lerpResult36_g1162 = lerp( temp_output_13_0_g1162 , ( temp_output_13_0_g1162 * temp_output_32_0_g1162 ) , temp_output_172_0_g1160);
				half3 temp_output_24_0_g1162 = worldNormal86_g1160;
				half dotResult15_g1162 = dot( lightDir55_g1162 , temp_output_24_0_g1162 );
				half temp_output_200_0_g1160 = _Translucency;
				half temp_output_40_0_g1162 = temp_output_200_0_g1160;
				half dotResult54_g1162 = dot( temp_output_24_0_g1162 , viewDIr52_g1162 );
				half dotResult57_g1162 = dot( viewDIr52_g1162 , lightDir55_g1162 );
				...
				half3 ViewDir126_g1160 = WorldViewDirection;
				...
				half3 localExpression_HairLighting_Additional126_g1160 = Expression_HairLighting_Additional126_g1160( Color126_g1160 , TangentWorld126_g1160 , ViewDir126_g1160 , NormalWorld126_g1160 , SpecularColor126_g1160 , SpecularTint126_g1160 , SpecularPower126_g1160 , SpecularMultiplier126_g1160 , PositionWorld126_g1160 , Translucency126_g1160 , RimTransmission126_g1160 , RimPower126_g1160 );
				...
				half3 bakedGI53_g1160 = ASEIndirectDiffuse( input, worldNormal86_g1160, WorldPosition, WorldViewDirection );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g1162 + ( ( saturate( ( ( dotResult15_g1162 * ( 1.0 - temp_output_40_0_g1162 ) ) + temp_output_40_0_g1162 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1162 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1162 ) , 0.0 ) ) , temp_output_208_0_g1160 ) * temp_output_207_0_g1160 ) ) * temp_output_32_0_g1162 ) ) * ase_lightColor ) ) ) + half4( localExpression_HairLighting_Additional126_g1160 , 0.0 ) ) * lerpResult280_g1160 ) + ( half4( max( bakedGI53_g1160 , float3( 0,0,0 ) ) , 0.0 ) * temp_output_42_0_g1160 * temp_output_161_0_g1160 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
