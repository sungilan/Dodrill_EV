Shader "AdaptiveGI/Terrain/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/AdaptiveGI/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
    ...
    Dependency "AddPassShader" = "Hidden/AdaptiveGI/Terrain/Lit (Add Pass)"
