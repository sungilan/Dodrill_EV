...
namespace HangulVirtualKeynoard
{
    ...
    public class HangulHelper
    {
        ...
        private static readonly char[] SingleJaMap = new char[]
        {
            'ㄱ','ㄲ','ㄴ','ㄷ','ㄸ','ㄹ','ㅁ','ㅂ','ㅃ','ㅅ',
            'ㅆ','ㅇ','ㅈ','ㅉ','ㅊ','ㅋ','ㅌ','ㅍ','ㅎ'
        };
        ...
        {
            if (value >= 0 && value < SingleJaMap.Length)
                return SingleJaMap[value];
            return '\0';
        }
        ...
        {
            byte[] byteArray = BitConverter.GetBytes((short)(0x314F + value));
